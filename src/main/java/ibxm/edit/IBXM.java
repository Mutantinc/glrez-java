/**
* Copyright <a href="mailto:mumart@gmail.com.">Martin Cameron</a>
* Adapted by <a href="mailto:fabmars@gmail.com">Fabien Marsaud</a> to expose the pattern and row numbers to allow synchronization
* 
* Package changed to avoid jar signer information mismatch with "other classes of the same package" (those of ibxm-a61-signed.jar actually)
* This will happen when ibxm-a61.jar is signed with another cert than this jar's.
*/
package ibxm.edit;
...
*/
public class IBXM {
	public static final String VERSION = "a61 (c)2011 mumart@gmail.com +getSeqPos +getRow";
